...
public class Backtest {
    ...
    public static void main(String[] args) {
        ...
        // int from = (int) ZonedDateTime.now().minusYears(2).toEpochSecond();
        // int to = (int) ZonedDateTime.now().minusYears(1).toEpochSecond();
        ...
        SigmaIndicator btcSigma = new SigmaIndicator(btcClose, window/10);
        SigmaIndicator altSigma = new SigmaIndicator(altClose, window/10);
        ...
        System.out.println("Number of ALT Trades: " + altShortRecord.getPositionCount() + altLongRecord.getPositionCount());
        ...
        double totalReturn = (grossReturn.calculate(altBarSeries, altShortRecord).doubleValue() * 100 - 100)
