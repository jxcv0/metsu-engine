...
public class Backtest {
    ...
    public static void main(String[] args) {
        ...
        SigmaIndicator btcSigma = new SigmaIndicator(btcClose, 1000);
        SigmaIndicator altSigma = new SigmaIndicator(altClose, 1000);
        DifferenceIndicator pair = new DifferenceIndicator(btcSigma, altSigma);
        StandardDeviationIndicator deviation = new StandardDeviationIndicator(pair, 1000);
        ...
        Strategy altShort = new BaseStrategy("ALT",  new CrossedDownIndicatorRule(pair, bbl), new CrossedUpIndicatorRule(pair, bbm));
